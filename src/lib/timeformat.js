 ...
 */
import { localStorage } from "@/lib/web-storage";
...
;(function(TimeFormat) {
  TimeFormat["TWELVE_HOUR"] = "h:mma"
  TimeFormat["TWENTY_FOUR_HOUR"] = "HH:mm"
})(TimeFormat || (TimeFormat = {}))

export const setIs24hClockInLocalStorage = is24h =>
...
export const getTimeFormatStringFromUserTimeFormat = timeFormat => {
